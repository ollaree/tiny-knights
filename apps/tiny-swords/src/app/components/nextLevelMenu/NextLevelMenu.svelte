<script lang="ts">
  ...
  export let createNewLevel: () => void;
    ...
    const items: Array<ImprovementItemType> = [
        {name: "Life", type: ImprovementTypes.LIFE, cost: {type: ResourcesType.WOOD, price: 1}, icon: './img/UI/1.png', available: true},
        {name: "Slot", type: ImprovementTypes.LIFE_SLOT, cost: {type: ResourcesType.GOLD, price: 100}, icon: './img/UI/Regular_10.png', available: true},
        {name: "Shield", type: ImprovementTypes.SHIELD, cost: {type: ResourcesType.GOLD, price: 300}, icon: './img/UI/shield.png', styles: {icon_wrapper: 'top: 34%'}, available: false },
        {name: "Weapon", type: ImprovementTypes.ARCHER_BOW, cost: {type: ResourcesType.WOOD, price: 20}, icon: './img/UI/archer_bow.png', styles: {icon: 'scale: 1.2'}, available: false },
        {name: "Assistant", type: ImprovementTypes.ARCHER, cost: {type: ResourcesType.GOLD, price: 1000}, icon: './img/UI/archer.png', styles: {icon: 'scale: 1.2'}, available: false },
        {name: "Dynamite", type: ImprovementTypes.TNT, cost: {type: ResourcesType.WOOD, price: 30}, icon: './img/UI/tnt.png',styles: {icon_wrapper: 'top: 32%'}, available: false },
    ]
</script>
