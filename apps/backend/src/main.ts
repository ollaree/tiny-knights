...
// Changed imports to use the exported httpServer and io from your server.ts file
import { server } from './server/server'; 
import { Connection } from './connection/connection';
import { Game } from './game/game';

// The port your game will run on
const port = Number(process.env.PORT) || 3016; 
const destroy$ = new Subject<void>(); 

// Use the imported httpServer to listen on the correct port
server.listen(port);
 ...
 * Pass the imported 'io' instance to your Connection class.
 */
